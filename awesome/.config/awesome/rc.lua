...
beautiful.init("/home/talhaa/.config/awesome/theme.lua")
...
praisewidget.text = " -- BY STRENGTH AND GUILE -- "
mylauncher = awful.widget.launcher({ image = beautiful.awesome_icon,
                                     menu = mymainmenu })
-- batterywidget = wibox.widget.textbox()
-- batterywidget.text =  finish!!!
...
globalkeys = gears.table.join(
    ...
    awful.key({                   }, "XF86MonBrightnessUp", function () awful.spawn("python3 /home/talhaa/Brightness/brightnessup.py") end,
    	      {description = "raise brightness", group = "awesome"}),
    awful.key({  		  }, "XF86MonBrightnessDown", function () awful.spawn("python3 /home/talhaa/Brightness/brightnessdown.py") end,
    ...
    awful.util.spawn("dmenu_run -nb '#000000' -sb '#3f3f3f' -l 39") end,
